...
func buildContent(m *project.Meta) string {
	...
	// Auto-generated header — visible in raw file, invisible in rendered Markdown.
	sb.WriteString("<!--\n")
	sb.WriteString("------------------------------------------------------------------------------\n")
	sb.WriteString("AUTO-GENERATED BY PRJ\n\n")
	sb.WriteString("This file is managed by `prj` and may be regenerated at any time.\n\n")
	sb.WriteString("Do not edit this file manually.\n\n")
	sb.WriteString("Instead:\n")
	sb.WriteString("- Update the project using `prj`\n")
	sb.WriteString("- Modify the installed Claude skills\n")
	sb.WriteString("- Update files under `.prj/`\n\n")
	sb.WriteString("Manual changes to this file may be overwritten.\n\n")
	sb.WriteString(fmt.Sprintf("Generated by: prj\nSchema Version: %d\n", m.SchemaVersion))
	sb.WriteString("------------------------------------------------------------------------------\n")
	sb.WriteString("-->\n\n")
